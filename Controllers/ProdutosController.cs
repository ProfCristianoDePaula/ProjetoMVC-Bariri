...
namespace ProjetoMVC.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,Nome,Preco,QtdadeEstoque,DataCadastro,CategoriaId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ProdutoId,Nome,Preco,QtdadeEstoque,DataCadastro,CategoriaId")] Produto produto)
        {
